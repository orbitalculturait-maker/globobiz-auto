...
module.exports = {
  ...
  // Verifica post-scrittura: dopo aver scritto il piano, l'app rilegge
  // WM_GetListIncomingNumber e controlla che fasce/destinazioni siano presenti.
  VERIFY_AFTER_WRITE: true,

  // Metodi ufficiali da documentazione Gloobobiz.
  PERSONAL_NUMBERS_LIST_OP: 'WM_GetListPersonalNumber',
  IVR_LIST_OP: 'WM_GetListIVR',
};
